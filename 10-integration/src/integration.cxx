...
public:
    // Factor (not used!)
    inline virtual double factor(double a, double b) override final {return 1;}
    
    // Mapping (not used!)
    inline virtual double mapping(double xi, double a, double b) override final {return 0;}
    
    // Integrator: functor
    virtual double integrate(const double (*func)(const double x), double a, double b) override final
    {
        double m = 0.5*(a+b);
        return (b-a)*func(m);
    }
    ...
    virtual double integrate(std::function<double(double)> func, double a, double b) override final
    {
        double m = 0.5*(a+b);
        return (b-a)*func(m);
    }   
...
public:
    ...
    // Integrator: functor
    double integrate(const double (*func)(const double x), double a, double b) override final
    {
        double m = 0.5*(a+b);
    ...
    // Integrator: lambda expression
    double integrate(std::function<double(double)> func, double a, double b) override final
    {
        double m = 0.5*(a+b);
        return (b-a)/6.0*(func(a)+4.0*func(m)+func(b));
    }
...
public:
    ...
    // Factor
    inline virtual double factor(double a, double b) override final
    {
        return (b-a)/2.0;
    }
    
    // Mapping from reference interval [-1,1] to [a,b]
    inline virtual double mapping(double xi, double a, double b) override final
    {
